...
class OverclockHandler:
    ...
    def overclockRecipe(self, recipe):
        ...
        machine_overrides = {
            ...
            'XLST': lambda recipe: self.modifyXT(recipe, 'steam_fuels'),
            ...
            'industrial mixer': self.modifyGTpp,
            'industrial sifter': self.modifyGTpp,
            'large thermal refinery': self.modifyGTpp,
            'industrial thermal centrifuge': self.modifyGTpp,
            ...
            'LPF': self.modifyGTpp,
            'high current industrial arc furnace': self.modifyGTpp,
            ...
            'industrial rock breaker': self.modifyGTpp,
            ...
            'ICO': lambda recipe: self.modifyGTppSetParallel(recipe, 24, speed_per_tier=0.96),
